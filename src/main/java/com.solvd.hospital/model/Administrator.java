...
public class Administrator extends Employee {
    ...
    public Administrator(String firstName, String lastName, BigInteger nationalId, int age, String gender, String address, String email, Smartphone smartphone, BigInteger salary, Hospital hospital) {
